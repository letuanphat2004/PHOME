import { Building2, CalendarDays, LayoutDashboard, LogOut, Menu, UserRound, X } from "lucide-react";
        ...
        >
          ...
          {user ? (
            <>
              ...
              {user.role === "Tenant" && <NavLink to="/appointments"><CalendarDays size={17} /> Lịch đã đặt</NavLink>}
